...
public class AreaController {
	...
	@ResponseBody
	public Map<String, Object> refund(@RequestBody JSONObject json) throws Exception {
		System.out.println(json);
		WeixinUtil.Refund(json.getString("out_trade_no"), json.getInteger("total_fee"), json.getInteger("refund_fee"));
	    return CommonUtil.resultMsg("SUCCESS", "刪除成功");
	}
}
